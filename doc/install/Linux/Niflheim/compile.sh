...
echo "source /home/camp/modulefiles.sh&& module load open64/4.2.3-0&& module load NUMPY&& cd $GPAW_HOME&& python setup.py --remove-default-flags --customize=./doc/install/Linux/Niflheim/el5-xeon-open64-goto2-1.13-acml-4.4.0-hdf.py build_ext 2>&1 | tee compile-el5-xeon-open64-goto2-1.13-acml-4.4.0-hdf.log" | ssh thul bash
