...
s = Spline(1, rc, 2 * x**1.5 / np.pi * np.exp(-x * r**2))
...
c_ai = {0: np.array([1.9 - 4.5j, 0, 0])}
c_ai = {0: np.array([1.0 - 0.0j, 0, 0])}
c.add(b, c_ai, 0)
print gd.integrate(b)
b = abs(b)
